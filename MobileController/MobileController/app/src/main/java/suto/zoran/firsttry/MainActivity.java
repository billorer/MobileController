...
public class MainActivity extends AppCompatActivity implements JoyStick.JoystickListener {
    ...
    public void onBackButton(View v) {
        LinearLayout linearLayout = (LinearLayout) findViewById(R.id.clientConnectionLayout);
        linearLayout.setVisibility(View.VISIBLE);

        LinearLayout linearLayout2 = (LinearLayout) findViewById(R.id.connectionLayout);
    ...
    public void onTapButton(View v) {
        ...
        EditText editText = (EditText) findViewById(R.id.clientCodeText);
    ...
    /** This is the action for the connection button*/
    public void onConnectClientButton(View v) {
        EditText editText = (EditText) findViewById(R.id.clientIpText);
    ...
    /** This is the action for the connection button*/
    public void exitClientButton(View v) {
